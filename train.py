...
print(char_dict.char2idx)
print(char_dict.idx2char)
...
# Transformer model
seq2seq = TransformerSeq2Seq(len(char_dict.char2idx), char_dict, loss_function, batch_size=BATCH_SIZE, max_len=MAX_LEN,
                           n_layers=HIDDEN_LAYERS, n_dim=HIDDEN_SIZE, teacher_forcing_ratio=TEACHER_FORCING_RATIO, n_head=NUM_HEAD)
...
for e in range(EPOCH):
    ...
    for b, data in enumerate(train_loader):
        ...
        print('Train Loss:', seq2seq.train_model(data).item())
    print('Valid Loss:', seq2seq.eval_model(data).item())
